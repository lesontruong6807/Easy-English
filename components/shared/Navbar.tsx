...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-[#e8e0d0] dark:border-[#36332e] bg-[#f7f4ec] dark:bg-[#181715] pt-[env(safe-area-inset-top,0px)] transition-colors shadow-2xs">
